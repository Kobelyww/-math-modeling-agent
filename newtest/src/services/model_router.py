...
class ModelRouter:
    ...
    def _build_task_keywords(self) -> Dict[TaskCategory, List[str]]:
        ...
        return {
            ...
            TaskCategory.MULTIMODAL: [
                "图片", "图像", "图表", "照片", "扫描", "视觉",
                "image", "picture", "photo", "chart", "graph", "visual"
            ],
            TaskCategory.OCR: [
                "ocr", "识别文字", "提取文字", "扫描", "手写",
                "recognize text", "extract text", "scan"
            ],
            ...
            TaskCategory.IMAGE_DESCRIPTION: [
                "描述图片", "图片内容", "图片里", "图中",
                "describe image", "image content", "what's in the image"
            ],
            
            # DeepSeek V4 擅长的任务
            TaskCategory.REASONING: [
                "推理", "逻辑", "分析", "为什么", "原因",
                "reason", "logic", "why", "because", "analyze"
            ],
            TaskCategory.MATH_REASONING: [
                "计算", "数学", "求解", "证明", "公式推导",
                "calculate", "math", "solve", "prove", "derivation"
            ],
            TaskCategory.CODE_GENERATION: [
                "代码", "编程", "实现", "函数", "算法",
                "code", "programming", "implement", "function", "algorithm"
            ],
            ...
            TaskCategory.LONG_TEXT: [
                "长文", "文档", "论文", "文章", "全文",
                "long text", "document", "paper", "article", "full text"
            ],
            ...
            TaskCategory.CREATIVE: [
                "创作", "写", "故事", "诗歌", "创意",
                "create", "write", "story", "poem", "creative"
            ],
            TaskCategory.EXTRACTION: [
                "提取", "抽取", "获取", "找出",
                "extract", "get", "find", "retrieve"
            ],
        }
    ...
    def analyze_task(self, task_description: str, context: Optional[Dict[str, Any]] = None) -> TaskAnalysis:
        ...
        model, confidence = self._select_model(
            category, complexity, requires_multimodal, 
            requires_reasoning, requires_long_context
        )
    ...
    def _assess_complexity(self, task: str, context: Optional[Dict[str, Any]] = None) -> TaskComplexity:
        """评估任务复杂度"""
        # 高复杂度指标
        high_complexity_keywords = [
            "复杂", "深入", "综合", "多步骤", "全面", "详细分析",
            "complex", "deep", "multi-step", "comprehensive", "detailed analysis",
            "系统性", "多维度", "跨领域", "systematic", "multi-dimensional"
        ]
        
        # 低复杂度指标
        low_complexity_keywords = [
            "简单", "快速", "简短", "概述", "简介",
            "simple", "quick", "short", "overview", "brief"
        ]
    ...
    def _requires_multimodal(self, task_lower: str) -> bool:
        """检测是否需要多模态"""
        multimodal_keywords = [
            "图片", "图像", "图表", "照片", "扫描", "视觉", "表格", "公式",
            "image", "picture", "photo", "chart", "graph", "visual", "table", "formula"
        ]
    ...
    def _requires_reasoning(self, task_lower: str) -> bool:
        ...
        reasoning_keywords = [
            "推理", "逻辑", "分析", "为什么", "原因", "证明",
            "reason", "logic", "why", "because", "prove", "analyze"
        ]
    ...
    def get_model_for_task(self, task_description: str, context: Optional[Dict[str, Any]] = None) -> str:
        """获取任务对应的模型"""
