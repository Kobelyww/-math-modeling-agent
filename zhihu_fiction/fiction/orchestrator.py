...
from zhihu_fiction.fiction.agents import create_coordinator, create_drama_video_coordinator, ReviewerAgent
...
class OrchestratorCompat:
    ...
    def __init__(
        ...
        """
        from zhihu_fiction.core.llm import create_llm
        from zhihu_fiction.fiction.agents import create_coordinator, ReviewerAgent
