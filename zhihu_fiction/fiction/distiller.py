"""Skill distillation for extracting reusable fiction-writing patterns."""
...
from zhihu_fiction.core.config import APP_ROOT, Settings
from zhihu_fiction.core.llm import create_llm
